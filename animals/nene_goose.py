...
from interfaces import Identifiable, IFlying, IWalking, ISwimming, ITerrestrial

class NeneGoose(Animal, Identifiable, IFlying, IWalking, ISwimming, ITerrestrial):
