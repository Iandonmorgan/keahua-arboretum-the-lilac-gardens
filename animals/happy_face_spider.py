...
from interfaces import Identifiable, IWalking, ITerrestrial, IHospitable, IStagnant

class HappyFaceSpider(Animal,Identifiable, IWalking, ITerrestrial, IHospitable, IStagnant):
